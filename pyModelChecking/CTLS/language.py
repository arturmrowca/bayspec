...
class W(TemporalOperator,AlphabeticSymbol):
    def get_equivalent_restricted_formula(self):
        ''' Return an equivalent formula in the restricted syntax.
        ...
        equi_neg_sf1 = LNot(subformulas[1])

        Lang=sys.modules[self.__module__]
        return Lang.Not(Lang.U(equi_neg_sf1,Lang.Or(subformulas[0],subformulas[1])))

    def is_a_state_formula(self):
        return False

    def __str__(self):
        return '(%s W %s)' % (self._subformula[0],self._subformula[1])
